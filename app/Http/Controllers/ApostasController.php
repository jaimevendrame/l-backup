    ...
    public function retornaApostas($ideven){
        ...
        $data = DB::select (
            ...
            "SELECT SUM(APOSTA_PALPITES.VLRPALP) AS VLRPALP,
              ...
              REVENDEDOR.IDEREVEN, REVENDEDOR.NOMREVEN, REVENDEDOR.CIDREVEN, VENDEDOR.NOMVEN, '$datIni' AS DATAINI, '$datFim' AS DATAFIM
              FROM APOSTA
            ...
            GROUP BY
              APOSTA.NUMPULE, APOSTA.DATGER, APOSTA.HORGER, APOSTA.DATENV, APOSTA.HORENV, APOSTA.SITAPO,
              REVENDEDOR.IDEREVEN, REVENDEDOR.NOMREVEN, REVENDEDOR.CIDREVEN, VENDEDOR.NOMVEN
